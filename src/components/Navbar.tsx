...
const Navbar = () => {
  ...
  return (
    <div
      className='bg-my-image bg-cover'
    >
      <div>
        {/* Desktop mode */}
        <div className='hidden md:flex items-center justify-between px-9 py-3  text-white'>
          <div className='flex items-center'>
            <Image src='/logo.svg' width={20} height={20} alt='logo' />
            <h1 className='text-xl tracking-tighter font-semibold ml-2'>
              GenAI
            </h1>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className='fixed bg-my-image bg-opacity-95  p-5 md:p-0 z-10 md:hidden bg-hi text-white w-full'>
